...
@section('content')
        ...
        <form action="{{ route('invite') }}" method="POST" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 1rem; align-items: flex-end;">
            ...
            @if(Auth::user()->isSuperAdmin())
                <div class="form-group" style="margin-bottom: 0;">
                    ...
                    <input type="text" name="company_name" placeholder="New Company Ltd" required>
                </div>
    ...
    <div class="card">
        <h2>Team Members & Pending Invitations</h2>
                ...
                <tbody>
                    ...
                    @if(isset($companies))
                        ...
                        <tr>
                            ...
                            <td><span style="font-size: 0.75rem; font-weight: 600;">{{ $company->users_count }} Team Members</span></td>
                            <td><span style="background: rgba(34, 197, 94, 0.1); color: var(--success); font-size: 0.7rem; padding: 0.2rem 0.5rem; border-radius: 4px; font-weight: 700;">ACTIVE COMPANY</span></td>
                            @if(Auth::user()->isSuperAdmin())
                            <td>-</td>
                            @endif
                    ...
                    @if(count($invitations) == 0 && (!isset($members) || count($members) == 0) && (!isset($companies) || count($companies) == 0))
                    <tr>
